...
if ($mysqli->query($sqlDelete)) {
    ...
    if (isset($_FILES['archivo_xlsx'])) {
        ...
        if ($archivo_xlsx['error'] === UPLOAD_ERR_OK) {
            ...
            $encabezados[11] = 'TERM';
            $encabezados[12] = 'PAY_REAL_DATE';
            $encabezados[13] = 'ACUM_DATE';
            $encabezados[14] = 'TERM_CLOSE';
            $encabezados[15] = 'TYPE';
            ...
            try {
                while (($fila = fgetcsv($csvFile)) !== false) {
                    ...
                    $payRealDateFile = date('Y-m-d', strtotime($fila[12]));
                    $acumDateFile = date('Y-m-d', strtotime($fila[13]));
                    ...
                    $valoresEscapados[12] = $payRealDateFile;
                    $valoresEscapados[13] = $acumDateFile;
